...
public class FaceConversionUtil {
	...
	public void getFileText(Context context) {
		System.out.println("FaceConversionUtil:getFileText");
		ParseData(File_SD_utils.getEmojiFile(context), context);
	}
	...
	private void ParseData(List<String> data, Context context) {
		System.out.println("FaceConversionUtil:ParseData|data.size()"+data.size());
		if (data == null || emojis.size()>0) {//放置重复读取
			return;
		}
		...
		try {
			...
			System.out.println("FaceConversionUtil:pageCount&emojis.size()"+pageCount+"|"+emojis.size());
	...
	private List<ChatEmoji> getData(int page) {
		System.out.println("FaceConversionUtil:getData|getData"+page);
